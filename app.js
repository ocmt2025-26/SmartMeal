...
function logout(){ localStorage.removeItem('smartmeal_user'); updateProfileLink(); renderProfile(); toast('Logged out'); location.href='index.html'; }
...
async function updateOrderStatus(orderId, status){
  ...
  }catch(e){ console.error(e); toast('Failed to update order status'); }
}
...
async function deleteOrder(orderId){
  try{
    ...
    toast('Order deleted');
  }catch(e){ console.error(e); toast('Failed to delete order'); }
}
